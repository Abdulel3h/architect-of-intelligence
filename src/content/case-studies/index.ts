...
export const caseStudies = defineCaseStudies([
  {
    ...
    userOutput: {
      description:
        "مجموعة وكلاء يشتغلون مع بعض على المحتوى والفرص، مع مراجعة بشرية قبل أي مخرج مهم.",
      problem:
        "الشغل اليدوي في المحتوى والفرص كان يبطئ التسليم ويكرر نفس القرارات بين الفريق.",
      systemDesign:
        "قسمنا الشغل بين وكلاء متخصصين للبحث والكتابة والفرز والإثراء، وحطينا موافقات بشرية في النقاط الحساسة.",
      architectureSummary:
        "مسار وكلاء يبدأ من الطلب، يوزع المهمة، يراجع المخرجات، ثم يقيس الجودة والتوفير.",
      metrics: [
        {
          label: "تحسن الكفاءة",
          value: "85%",
  ...
  },
  {
    ...
    userOutput: {
      description:
        "نظام معرفة خاص يجاوب من مستندات داخلية موثوقة، مع مصادر واضحة وطريقة نشر آمنة.",
      problem:
        "المعرفة التقنية والتشغيلية كانت متفرقة، فالدعم يصير أبطأ والخبرة ما تنعاد بسهولة.",
      systemDesign:
  ...
  },
  {
    ...
    userOutput: {
      ...
      architectureSummary:
        "نمط منتج كامل يربط المستخدم بطبقة الذكاء والبيانات والقياس.",
      metrics: [
        {
          label: "طريقة البناء",
        ...
        },
        {
          label: "المجالات",
          value: "4+",
          context: "قانونية ومالية وتعليمية وتحليلية",
        },
      ],
